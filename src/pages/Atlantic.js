      ...
      <div className="background-container-atlantic" onWheel={handleScroll} ref={containerRef}>
        <div className = "background-image-atlantic">
          <Grid templateColumns='repeat(5, 1fr)' gap={6}>
            <GridItem w='100%'><IntroCard title="The Atlantic Ocean" description="Explore Marco Polo's journey through the Silk Road and find new artifacts along the way!"></IntroCard></GridItem>
            ...
            <GridItem w='100%' h='100vh'></GridItem>
          </Grid>
