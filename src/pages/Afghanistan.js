        ...
        {!isLoading && (
          <div className = "background-image-atlantic">
            <Grid templateColumns='repeat(6, 1fr)' gap={6}>
              <GridItem w='100%'>
                <IntroCard title="Afghanistan" description="One of the countries the Polos traveled through early in his journey was Afghanistan.">
                </IntroCard>
              </GridItem>
              ...
              <GridItem w='100%' h='100vh' >
                <ArtifactCard 
                  posFromTop='40vh' 
                  artifact='https://www.youtube.com/embed/6JAYYAmcuSM?si=aV6rG_6qM5AAk4I5&amp;autoplay=1&controls=0&mute=1' 
                  artifactDescription={[
              ...
              <GridItem w='100%' h='100vh'>
                <StaticCard 
                    ...
                    posFromTop='20vh'
                    hasImage={false}
                    text='I hope you’ve had fun in Afghanistan! Let’s keep heading eastward… on to the Mongol Empire!'
                  />
              </GridItem>
              <GridItem w='100%' h='100vh'>
